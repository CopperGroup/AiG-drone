      ...
      {isOrderCreated ? (
        ...
        >
          ...
          <motion.div
            ...
            className="bg-green-50 rounded-full p-8 mb-8 overflow-hidden"
          >
            <motion.div
          ...
          >
            ...
            >
              <Button
                ...
                className="bg-green-500 hover:bg-green-600 px-6 py-3 rounded-lg text-base-medium text-white transition duration-300 w-full sm:w-auto"
              >
            ...
            <AnimatePresence>
              {showThankYou && (
                <motion.div
                  ...
                  className="mt-12 text-body-semibold text-green-500"
                >
                  Дякуємо за покупку!
                </motion.div>
              )}
            ...
            <div className="lg:col-span-2">
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                  ...
                  <Button
                    type="submit"
                    className="w-full md:w-auto bg-green-500 hover:bg-green-600 text-base-medium text-white hover:shadow-md hover:shadow-green-400/20 transition-all duration-300"
                  >
              ...
              <div className="bg-white rounded-lg shadow-sm border border-zinc-100 overflow-hidden">
                  ...
                  {cartData.map((item: any, index: number) => (
                    ...
                    >
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-base-medium text-green-500">
                ...
                <div className="p-4 bg-zinc-50 border-t border-zinc-100">
                  ...
                  <div className="mt-4 pt-4 border-t border-zinc-100 flex justify-between items-center">
                    ...
                    <span className="text-heading4-medium text-green-500">
                      {priceToPay}
                      {Store.currency_sign}
                    </span>
                  </div>
