    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <Link href={category.href} className="block">
                <div className="relative aspect-[1/1] overflow-hidden rounded-lg shadow-lg">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-green-900/10 to-green-700/5 transition-opacity duration-300 group-hover:from-green-900/80 group-hover:to-green-700/50" />
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
                    ...
                    <motion.span
                      className="text-small-semibold uppercase tracking-wider text-white border border-white px-4 py-2 hover:bg-white hover:text-green-700 transition-colors duration-300"
                      initial={{ opacity: 0, y: 20 }}
        ...
        >
          <Link
            href="/catalog"
            className="inline-block text-base-semibold text-green-600 hover:text-green-800 transition-colors duration-300 relative group"
          >
            <span className="relative z-10">Всі категорії</span>
            <span className="absolute bottom-0 left-0 w-full h-0.5 bg-green-600 transform origin-left transition-all duration-300 group-hover:scale-x-100 scale-x-0"></span>
          </Link>
        </motion.div>
      </div>
    </motion.section>
