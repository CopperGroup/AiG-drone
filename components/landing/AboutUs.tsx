        ...
        <div className="relative">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-6">
                {features.map((feature, index) => (
                  ...
                  >
                    <div className="flex-shrink-0 w-px h-6 bg-green-500 mt-2" />
                    <div>
              ...
              >
                <Button
                  asChild
                  className="bg-green-500 hover:bg-green-600 text-small-semibold transition-colors px-6 py-3 text-white"
                >
            ...
            >
              ...
              <div className="absolute -bottom-6 -left-6 w-48 h-48 border border-green-500 rounded-lg flex items-center justify-center p-4 bg-white shadow-lg">
