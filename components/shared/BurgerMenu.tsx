        ...
        <div className="fixed inset-x-0 top-20 bottom-0 bg-zinc-900 z-[9999]">
          <div className="h-full overflow-y-auto py-6 px-4 flex flex-col items-center">
            <nav className="flex flex-col items-center space-y-4 w-full">
              <AdminLink
                className="pt-2 hover:bg-transparent hover:text-green-500"
              ...
              {Links.map(({ label, href }) => {
                ...
                if (label === "Інформація") {
                  return (
                    <Menubar key={label} className="border-0 p-0 w-full">
                      <MenubarMenu>
                        <MenubarTrigger className="w-full flex justify-center items-center text-neutral-400 hover:text-green-400 focus:text-green-400">
                          <span className={`text-center ${isActive ? "text-green-400" : ""}`}>{label}</span>
                        </MenubarTrigger>
                        <MenubarContent className="bg-zinc-800 text-neutral-400 border-0 rounded-2xl">
                          <MenubarItem>
                            <TransitionLink
                              href="/info/about-us"
                              className="block py-2 w-full text-center hover:text-green-400"
                            >
                              Про нас
                            </TransitionLink>
                          </MenubarItem>
                          ...
                          <MenubarItem>
                            <TransitionLink href="/blog" className="block py-2 w-full text-center hover:text-green-400">
                              Блог
                            </TransitionLink>
                          </MenubarItem>
                        </MenubarContent>
                ...
                return (
                  <TransitionLink
                    key={label}
                    href={href}
                    className={`text-neutral-400 ${isActive ? "text-green-400" : ""} w-full text-center hover:text-green-400`}
