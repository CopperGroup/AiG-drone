  ...
  if (variant === "full") {
    return (
      <Button
        ...
        className="w-48 max-[425px]:w-full bg-white text-zinc-800 border border-green-500 hover:bg-green-500/10 hover:text-zinc-900 transition-all duration-300 group relative overflow-hidden"
      >
        <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-green-500/20 to-green-400/20 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500"></span>
    ...
    return (
      <Button
        onClick={AddDataToCart}
        className="bg-green-500 text-white hover:bg-green-500/90 hover:text-zinc-50 border border-green-500/50 transition-all duration-300 px-3 py-1 h-9 group relative overflow-hidden"
      >
