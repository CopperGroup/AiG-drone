...
const BuyNow = ({
  ...
  return (
    <Button
      ...
      className="max-[425px]:w-full bg-gradient-to-r from-green-500 to-green-400 text-white hover:shadow-lg hover:shadow-green-500/20 transition-all duration-300 relative group overflow-hidden"
    >
      <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-green-400 to-green-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></span>
      <GiDeliveryDrone className="mr-2 relative z-10" size={18} />
